...
export default {
  Children : {
    child_id  : (children: IChildren): string => children.child_id,
    parent_id : (children: IChildren): string => children.parent_id,

    child : (
      children: IChildren, _, { dataSources: { peopleAPI } }: IContext,
    ): Promise<unknown> => peopleAPI.getById(children.child_id),
  },
